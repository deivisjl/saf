...
<script>
    ...
    var obtener_data_editar = function(tbody,table){
         $(tbody).on("click","a.detalle",function(e){
            ...
            var id = data.id;
             window.location.href = "/pago-clientes/" + id + "/detalle";
          });
          $(tbody).on("click","a.pagar",function(e){
            ...
            var id = data.id;
             window.location.href = "/pago-clientes/" + id + "/abonar";
          });
