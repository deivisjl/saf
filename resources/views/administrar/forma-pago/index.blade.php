                ...
                <div class="card">
                    <div class="card-header-custom">
                        <h3 class="card-title">Formas de pago</h3>
                          ...
                          <a href="{{ route('forma-pago.create') }}" class="btn btn-primary btn-sm float-right">Nuevo registro</a>
...
<script>
    ...
    var obtener_data_editar = function(tbody,table){
         $(tbody).on("click","a.editar",function(e){
            ...
            var id = data.id;
             window.location.href = "/forma-pago/" + id + "/edit";
          });
