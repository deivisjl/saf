...
<script>
    export default 
    {
        ...
        created(){
            if(this.proveedor)
            {
                this.modelo.nombre = this.proveedor.nombre
                this.modelo.id = this.proveedor.id
                this.modelo.nit = this.proveedor.nit
                this.modelo.telefono = this.proveedor.telefono
                this.modelo.direccion = this.proveedor.direccion
            }
        },
        methods:{
            validar(){
            ...
            editar(){
                ...
                this.loading = true
                axios.put(abs_path + '/proveedores/' + this.modelo.id, data)
                    .then(r => {
                        this.loading = false
